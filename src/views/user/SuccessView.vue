    ...
    <div class="container mx-auto max-w-3xl my-16 px-4">
      <div class="card bg-base-100 shadow-lg border border-base-200">
        <div class="card-body items-center text-center py-12">
          ...
          <div v-if="orderData.orderNumber" class="w-full text-left bg-base-200/50 rounded-xl p-6 mb-8 border border-base-200">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-4">
              ...
              <div>
                ...
                <p class="font-medium">{{ orderData.createdDate }}</p>
              </div>
              <div>
              ...
              <div class="sm:col-span-2 pt-4 border-t border-base-300">
                ...
                <p class="text-sm mt-1 whitespace-pre-line text-base-content/80">{{ orderData.address }}</p>
                <div v-if="orderData.note" class="mt-3 bg-base-100 p-3 rounded-lg border border-base-200">
          ...
          <div class="card-actions justify-center w-full mt-2">
            <RouterLink to="/" class="btn btn-neutral w-full sm:w-auto px-10">Back to Home</RouterLink>
          </div>
